...
with mp_face_mesh.FaceMesh(
    ...
    while True:
        ...
        if pipeSpawnTimer == 0:
            ...
            top_pipe_height = random.randint(320, max(321, window_size[1] - space_between_pipes - 40))
            top = pipe_starting_template.copy()
            bottom = pipe_starting_template.copy()
            top.x, top.y = window_size[1], top_pipe_height
            bottom.x, bottom.y = window_size[1], top_pipe_height + space_between_pipes
